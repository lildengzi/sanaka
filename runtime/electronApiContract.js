const electronApiContract = {
  ...
  runtime: {
    ...
    applyControlledQemuArgEdit: { type: 'invoke', channel: 'runtime:apply-controlled-qemu-arg-edit' },
    normalizeCustomQemuArgs: { type: 'invoke', channel: 'runtime:normalize-custom-qemu-args' },
